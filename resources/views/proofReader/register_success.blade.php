                ...
                <div class="misc-wrapper"><a class="brand-logo" href="index.html">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-3 fw-bolder">Please check yor email and verify by clicking on the link you get in mail sent by us</p>
                            <a href="{{route('proof-reader.login')}}">Go back</a>
                            <img class="img-fluid" src="{{asset('app-assets/images/pages/coming-soon.svg')}}" alt="Coming soon page" />
                        </div>
                    </div>
                </div>
                <!-- / Coming soon page-->
