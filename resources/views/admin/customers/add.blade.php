    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
            <div class="card w-100">
                <div class="card-body">
                    <form action="{{route('admin.customers.insert')}}" method="POST" id="customerAddForm" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('Enter google ID for login with google')" name="sso_google_id" id="sso_google_id">
                            </div>
                            <div class="col-md-6 mb-1">
