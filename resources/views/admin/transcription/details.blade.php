                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.transcription.list') }}">Home</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <label class="mb-2"><strong>Transcription:</strong></label>
                                        <p>{{ $detail->transcription_from_api }}</p>
                                    </div>
