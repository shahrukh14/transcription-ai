...
<footer class="footer footer-static footer-light">
  @php
      ...
      $siteName = $generalSettings ? $generalSettings->name : 'Site Name';
  @endphp
  <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; {{ date('Y') }}<a class="ms-25" href="" target="_blank">{{ $siteName }}</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span></p>
</footer>
